...
<div class="form-group">
   ...
   <div class="form-group">
    ...
    <select id="userlanguage" name="lang">
       ...
       <div class="form-group">
	    <label for="userlan" class="col-sm-2 control-label">관심언어</label>
	    <input type=radio name="language" id="userlan" checked value="한국어">한국어
	    <input type=radio name="language" id="userlan" value="영어">영어
	    <input type=radio name="language" id="userlan" value="중국어">중국어
	    <input type=radio name="language" id="userlan" value="독일어">독일어
	    <input type=radio name="language" id="userlan" value="일본어">일본어
</div>
<div class="form-group">
    ...
    <form method=post action="photo.do" name="upload" id="upload" enctype="multipart/form-data">
